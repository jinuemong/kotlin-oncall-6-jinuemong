...
- 요일 테스트
  - [x] 정상적인 요일 입력 시 테스트
  - [x] 부정확한 요일 입력 시 예외 테스트 
  - [x] 정상적인 요일 인덱스 입력 테스트
  - [x] 부정확한 요일 입력 시 예외 테스트
  - [x] 정상적인 요일 인덱스 반환 테스트
  - [x] 부정확한 요일 입력 시 인덱스 반환 예외 테스트 
- 요일 유형(평일/주말/휴일) 구분 테스트
  - [x] 정확한 요일 입력과 휴일 시 테스트
  - [x] 정확한 요일 입력과 휴일이 아닐 시 테스트
  - [x] 정확하지 않은 요일 입력과 휴일 시 예외 테스트
  - [x] 정확하지 않은 요일 입력과 휴일이 아닐 시 예외 테스트